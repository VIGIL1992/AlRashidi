          ...
          <div class="col-xl-8 col-lg-9 d-flex align-items-center justify-content-start">
            <div class="header-top-info">
              <div class="header-contact-info">
                ...
                <span><a href="mailto:hello@transico.com"><i class="fa-solid fa-envelope"></i>sales@alrashdi.com</a>
                </span>
                <span><a href="tel:+966509966628"><i class="fa-solid fa-phone"></i>+966 50 99 666 28</a></span>
              </div>
            </div>
          </div>
            ...
            <div class="menu d-inline-block">
              <nav id="main-menu" class="main-menu">
                <ul>
                  ...
                  <li class="<?php if( ($cur_page == 'about.php') ) {echo 'active';} ?>"><a href="about.php">About</a></li>
                  <li class="dropdown <?php if ($cur_page == 'brown_black.php' || $cur_page == 'grand_food.php' || $cur_page == 'happy_booth.php' || $cur_page == 'products.php') {echo 'active';} ?>">
                      <a href="branch.php">Division</a>
                      <ul class="submenu">
                        <li class="<?php if( ($cur_page == 'brown_black.php') ) {echo 'active';} ?>"><a href="brown_black.php">Brown Black</a></li>
                        <li class="dropdown <?php if( ($cur_page == 'happy_booth.php') ) {echo 'active';} ?>">
                            <a href="happy_booth.php">Happy Booth</a>
                            
                        </li>
                        <li class="<?php if( ($cur_page == 'grand_food.php') ) {echo 'active';} ?>"><a href="grand_food.php">Grand Food</a></li>
                      </ul>
                  </li>
                  <li class="<?php if( ($cur_page == 'contact.php') ) {echo 'active';} ?>"><a href="contact.php">Contact</a></li>
                </ul>
              </nav>
            </div>
            <!-- Header Button Start !-->
