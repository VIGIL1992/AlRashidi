...
<footer class="footer style-two background-black">
    <div class="footer-triangle-image-wrapper">
        <div class="footer-triangle-image">
            <img src="images/background/coockie.jpg" alt="image" />
        </div>
    </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="footer-widget">
                        <div class="footer-widget-info">
                            ...
                            <p>We at Ai Rashidi Group, realize that a satisfied customer is the key to any success. Therefore, our 
                                values revolve around our customer’s satisfaction and we treat it as the basis for all what we 
                                offer.
                            </p>
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="contact-text">
                                                <a href="mailto:sales@alrasdhi.com"><span>sales@alrasdhi.com</span></a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="contact-icon">
