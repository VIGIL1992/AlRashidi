    ...
    <!-- <div class="slider-area style-3">
        <div class="slider-wrapper">
            ...
            <!-- <div class="single-slider-wrapper">
                <div class="single-slider" style="background-image: url('../images/coffee/slider-1.jpg')">
            ...
            <!-- single slider start -->
            <!-- <div class="single-slider-wrapper">
                <div class="single-slider" style="background-image: url('../images/coffee/slider-2.jpg')">
                    <div class="slider-overlay"></div>
                    <div class="container h-100 align-self-center">
                        <div class="row h-100">
                            <div class="col-md-12 align-self-center">
            ...
            <!-- single slider start -->
            <!-- <div class="single-slider-wrapper">
                <div class="single-slider" style="background-image: url('../images/coffee/slider-3.jpg')">
                    <div class="slider-overlay"></div>
                    <div class="container h-100 align-self-center">
                        <div class="row h-100">
                            <div class="col-md-12 align-self-center">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title another-title">
                        <span class="short-title">We are Brown Black</span>
                        <h2 class="title">World Class <span>Coffee</span>  <span> </span></h2>
                    </div>
                </div>
                    ...
                    <div class="about-info-card style-three">
                        ...
                        <div class="about-info-wrapper">
                            <div class="about-info-img">
                                <img src="../images/coffee/about-1.jpg" alt="image" />
                            </div>
                            <div class="about-info-content">
                                <div class="text">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiatmnis iste natus error sit voluptatem acycu sa mnis iste natus error sit volup.
                                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiatmnis iste natus error sit voluptatem acycu sa mnis iste natus error sit volup.
                                    </p>
                                </div>
                                ...
                                <div class="icon-card-wrapper">
                                    <div class="icon-card">
                                        ...
                                        <div class="content">
                                            <h2 class="title">World Class Service</h2>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 align-self-end">
                    <div class="promotional-banner-widget">
                        <div class="promotional-bannar-img">
                            <img class="tilt-animate" src="../images/coffee/about-2.jpg" alt="image" />
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center align-items-center mb-70">
                        ...
                        <h2 class="title">Discover the  <span>Perfect</span><br />for Your <span>Daily Brew</span></h2>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 team-space">
                    <div class="team-member-card">
                        <div class="image">
                            <img src="../images/brownblack/branches/Jazan-Al Shamil Center, Brown Black Cafe.jpg" alt="team-member" />
                        </div>
                        <div class="content-wrapper">
                            <div class="content">
                                <h2 class="title">Jazan</h2>
                                <p class="desc">Al Shamil Center</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 team-space">
                    <div class="team-member-card ">
                        <div class="image">
                            <img src="../images/brownblack/branches/Riyadh.jpg" alt="team-member" />
                        </div>
                        <div class="content-wrapper">
                            <div class="content">
                                <h2 class="title">Riyadh</h2>
                                <p class="desc">Al Makan Mal</p>
                            </div>
                        </div>
                    </div>
                </div>                
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mb-70">
                        ...
                        <h2 class="title text-white">We Bring Your <span>Smile</span> <br> with <span>Coffee</span>
                        </h2>
                    ...
                    <div class="video-popup-card style-two">
                        <div class="video-popup-image">
                            <img src="../images/coffee/why-chose-us.jpg" alt="popup image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="icon-card style-three">
                                    ...
                                    <div class="content">
                                        <h2 class="title">World Class Taste</h2>
                                        <p
                            ...
                            <div class="col-md-6">
                                <div class="icon-card style-three">
                                    ...
                                    <div class="content">
                                        <h2 class="title">Reliable & Experienced Partners</h2>
                                        <p
                            ...
                            <div class="accordion-list-item">
                                <div id="headingThree">
                                    <div class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <h3 class="accordion-title">Our Principal</h3>
                                        <div class="icon"></div>
                                    </div>
                                </div>
                    ...
                    <div class="about-image-card style-three">
                        <div class="main-img-wrapper">
                            <div class="main-img-inner">
                                <img class="tilt-animate" src="../images/coffee/question.jpg"
                                    alt="about card img" />
                                <div class="img-card-wrapper">
                                    <div class="image-six">
                                        <h1 class="year"><span class="counter">20</span>+</h1>
                                        <h6 class="title">Branches<br /></h6>
                                    </div>
